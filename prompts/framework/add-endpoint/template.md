...
برای افزودن endpoint جدید، از template زیر استفاده کنید و اطلاعات endpoint خود را جایگزین کنید:
...
- DETAIL: /categories/{id} (جزئیات دسته‌بندی)
- SEARCH: /categories/search (جستجوی دسته‌بندی‌ها)
- CREATE: /categories (ایجاد دسته‌بندی)
- UPDATE: /categories/{id} (به‌روزرسانی دسته‌بندی)
- DELETE: /categories/{id} (حذف دسته‌بندی)
- BULK_DELETE: /categories/bulk (حذف دسته‌ای)
...
**آماده‌اید endpoint جدید اضافه کنید؟ از template بالا استفاده کنید! 🚀**
