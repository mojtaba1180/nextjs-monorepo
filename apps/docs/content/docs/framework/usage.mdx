---
title: Usage Guide
description: راهنمای کامل استفاده از framework hooks و API calls
---

# 📖 Usage Guide

راهنمای کامل استفاده از framework package برای API calls و data management.
...
function ProductManagement() {
  ...
  return (
    <div>
      {/* استفاده از products و categories */}
    </div>
  );
}
```
...
بعد از یادگیری usage، می‌توانید:

1. **[Route Structure](./route-structure)** - ساختار API routes
2. **[Adding Endpoints](./adding-endpoints)** - افزودن endpoint جدید
3. **[Examples](./examples)** - مثال‌های عملی

---

**Usage یاد گرفتید؟ [Route Structure](./route-structure) را مطالعه کنید! 🚀**
