---
title: API Reference
description: Complete API reference and types in framework package
---

# 📋 API Reference

Complete reference for API, types and interfaces in framework package.
...
```typescript
// All endpoints in a central file
const API_ENDPOINTS = {
  AUTH: {
    LOGIN: "/auth/login",
    LOGOUT: "/auth/logout",
...
After studying API Reference, you can:

1. **[Usage Guide](./usage)** - Usage guide
2. **[Examples](./examples)** - Practical examples
3. **[Adding Endpoints](./adding-endpoints)** - Adding new endpoints

---

**API Reference completed! Now you can use the framework package! 🚀**
